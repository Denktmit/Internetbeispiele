...
namespace WPFUtils.LeveledTree {
  ...
  public class TreeLevel2ViewModel : TreeViewItemViewModel {
    ...
    public TreeLevel2ViewModel(TreeObject inObject, TreeLevel1ViewModel inParent) : base(inParent, true) {
      _object = inObject;
    }
      ...
      if (_object.SubObjects.Count != 0) {
        foreach (TreeObject obj in _object.SubObjects) {
          if (obj.SubObjects.Count == 0) {
            ...
            base.Children.Add(new TreeLevel3ViewModel(obj, this));
          }
          else {
